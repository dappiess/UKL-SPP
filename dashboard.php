      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="card shadow">
            ...
            <a href="laporan.php" class="stretched-link"><h4 class="text-center mt-1">Cek Histori</h4></a>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card shadow">
      ...
      <div class="row mt-4">
        <div class="col-md-4">
          <div class="card shadow">
            ...
            <a href="data-guru.php" class="stretched-link"><h4 class="text-center mt-1">Data Petugas</h4></a>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card shadow">
            <img src="assets/img/student(1).png" width="80px" class="mx-auto mt-3 mb-2">
            <a href="data-walikelas.php" class="stretched-link"><h4 class="text-center mt-1">Data Kelas</h4></a>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card shadow">
