      ...
      <div class="main col-md-6 offset-3">
        ...
        <form method="POST">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-6">
              <select type="text" name="kelas" class="form-control rounded-pill">
                ...
                <?php  
                  $kelas = mysqli_query($konek, "SELECT * FROM kelas ORDER BY kelas ASC");
          ...
          <div class="form-group row">
            ...
            <div class="col-md-3">
              <input type="text" name="biaya" class="form-control rounded-pill" value="600000" readonly>
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-4 offset-1 mt-1">
            ...
            <div class="col-md-4">
              <input type="text" name="tahunajaran" class="form-control rounded-pill" value="2020/2021" readonly>
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-4 offset-1 mt-1">
            ...
            <div class="col-md-3">
              <input type="text" name="jatuhtempo" class="form-control rounded-pill" value="2020-07-10" readonly>
            </div>
          </div>
          <div class="row">
