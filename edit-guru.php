<?php 
  ...
  include 'koneksi.php';
  $id = $_GET['id'];
  $tampil = mysqli_query($konek,"SELECT * FROM petugas WHERE idguru = $id");
  ...
  <div class="container">
    <div class="row">
      <div class="main col-md-6 offset-3">
        <h2 class="text-center mt-5">Update Data Petugas</h2>
        <form method="POST">
...
include 'koneksi.php';
  if (isset($_POST['update'])) {
    ...
    $update = mysqli_query($konek,"UPDATE petugas SET namaguru='$nama', alamat='$alamat', telp='$telp' WHERE idguru ='$id'");
